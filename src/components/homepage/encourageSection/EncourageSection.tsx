            ...
            <div className={styles.wrapper}>
                ...
                <div className={styles.content}>
                    <p>
                        ...
                        your needs. Don't delay - contact us now and give us a chance to resolve your legal issues. Put
                        your trust in our experienced law firm so you can look to the future with confidence.
                    </p>
